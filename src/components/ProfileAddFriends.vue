        ...
        <div class="page-container p-5 text-right">
          <div class="row">
            <div class="col-12 my-2">
              <div class="form-container pt-2 text-center">
              <p class="mx-auto" style="max-width:700px">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است</p>
              <p class="text-special-pink mx-auto" style="max-width:700px">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است.</p>
            </div>
            </div>
            <div class="col-12 my-2 mx-auto" style="max-width:500px">
              <label for="send-invitation" class="label-input" >لینک دعوت </label>
            ...
            <div class="col-12 my-2">
              <label for="address" class="label-input" >لیست دوستان شما</label>
