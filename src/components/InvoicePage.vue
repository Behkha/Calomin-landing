  ...
  <div class="container-fluid  pb-5 " style="max-width: 1400px; min-height: 100vh;  ">
    <div class="row ">
      <div class="col-12 my-5 ">
        ...
        <button class="btn btn-sm  title-button  d-block mx-auto  rounded-pill " style="margin-top:-25px"  >فاکتور</button>
      </div>
      <div class="col-12" v-if="invoice">
        <div class="container">
            <div class="modal-content " id="section-to-print">
              <div class="invoice-header p-4 mb-2">
               ...
               <div v-for="product in invoice.products" class="invoice-order-card d-flex justify-content-between pb-3 my-3 mx-auto">
                ...
                <div class="row">
                  <div class="col-md-5 col-12 mx-auto">
                    ...
                    <div class="d-flex justify-content-between my-3">
                      <span class="float-right invoice-pay-h">تخفیف:</span>
                      <span class="float-left  invoice-pay-s">{{invoice.total_discount | toCurrency}} تومان</span>
                    </div>
                    <div class="d-flex justify-content-between my-3">
                      <span class="float-right invoice-pay-h">میزان جایزه :</span>
                      <span class="float-left  invoice-pay-s">{{invoice.total_bonus | toCurrency}} تومان</span>
                    </div>
                    <div class="d-flex justify-content-between my-3">
                      <span class="float-right invoice-pay-h">جمع کل با حساب جایزه :</span>
                      <span class="float-left  invoice-pay-s">{{invoice.total_price_plus_bonus | toCurrency}} تومان</span>
                    </div>
                     <!-- <div class="d-flex justify-content-between my-3">
                  ...
                  <div class="col-md-5 col-12 mx-auto">
                     <div class="d-flex justify-content-between my-3" v-if="invoice.total_mass">
                       <span class="float-right invoice-pay-h">وزن سفارشات :</span>
                       <span class="float-left  invoice-pay-s ">{{invoice.total_mass | toCurrency}} تومان</span>
                     </div>
                     <div class="d-flex justify-content-between my-3" v-if="invoice.delivery_method">
                     ...
                     <div class="d-flex justify-content-between my-3">
                       <span class="float-right invoice-pay-h">مالیات بر ارزش افزوده:</span>
                       <span class="float-left  invoice-pay-s">{{invoice.total_tax | toCurrency}} تومان</span>
                     </div>
                     <div class="d-flex justify-content-between my-3">
                       <span class="float-right invoice-pay-h">قابل پرداخت :</span>
                       <span class="float-left  special-green h4">{{invoice.price + invoice.delivery_method.price | toCurrency}}تومان</span>
                     </div>
                     <!-- <div class="d-flex justify-content-between my-3">
                       <span class="float-right invoice-pay-h">قابل پرداخت:</span>
                       <span class="float-left   ">24000 تومان</span>
      ...
      <div class="col-12 mt-4">
        <button type="button" class="btn print-btn" @click="print()" ><img  src="../images/print.svg" class="mb-2" style="width: 40px;"></img> </br> چاپ فاکتور</button>
      </div>
    </div>
  </div>
</template>
